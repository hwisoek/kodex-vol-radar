        ...
        if N_total >= 30:
            ...
            if "portfolio_history" in st.session_state and len(st.session_state["portfolio_history"]) > 0:
                ...
                fig = make_subplots(
                    ...
                    subplot_titles=(
                        "📈 포트폴리오 누적 수익률 곡선 (Cumulative Return %)",
                        "📉 낙폭 (Drawdown %)"
                    )
                )
                ...
                fig.add_trace(
                    go.Scatter(
                        ...
                        hovertemplate="<b>%{x|%m/%d %H:%M}</b><br>누적 수익: <b>%{y:+.3f}%</b><extra></extra>"
                    ),
                    row=1, col=1
                )
                # 0% 기준선
                ...
                fig.add_trace(
                    go.Scatter(
                        ...
                        hovertemplate="<b>%{x|%m/%d %H:%M}</b><br>낙폭: <b>%{y:.2f}%</b><extra></extra>"
                    ),
                    row=2, col=1
                )
                # MDD 포인트 마커
                ...
                fig.update_layout(
                    ...
                    xaxis2=dict(showgrid=True, gridcolor="rgba(148,163,184,0.1)", zeroline=False),
                    yaxis=dict(
                        showgrid=True,
                        ...
                        ticksuffix="%",
                        tickformat=".2f",
                        title=dict(text="누적 수익률", font=dict(size=11)),
                        automargin=True,
                    ),
                    yaxis2=dict(
                        showgrid=True,
                        ...
                        ticksuffix="%",
                        tickformat=".2f",
                        title=dict(text="낙폭", font=dict(size=11)),
                        automargin=True,
                    ),
                )
