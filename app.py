...
def analyze_60d_macro_regime(h_data, current_price, trading_hours=6.5):
    ...
    if is_bull:
        ...
        if macro_pos >= 90.0:
            ...
            color = "#dc2626"
            desc = "더 이상 오르기 힘든 꼭대기입니다. 욕심부리지 말고 모두 팔 준비를 하세요."
            action = "전량 익절 대기"
        elif macro_pos >= 80.0:
            ...
            color = "#94a3b8"
            desc = "오르다가 잠시 숨을 고르고 있습니다. 무리해서 사지 말고 지켜보세요."
            action = "관망"
        elif macro_pos >= 20.0:
            ...
            color = "#b91c1c"
            desc = "튼튼하던 지지선이 깨질 위험이 있습니다. 상승 기대감을 버리고 도망칠 준비를 하세요."
            action = "손절 대기"
    ...
    # ---------------------------------------------------------
        ...
        if macro_pos >= 90.0:
            ...
            color = "#ef4444"
            desc = "잠깐 반짝 오르는 중입니다. 이때를 틈타 물려있는 것을 조금씩 손절하세요."
            action = "비중 축소"
        elif macro_pos >= 65.0:
            ...
            color = "#64748b"
            desc = "떨어지는 속도가 붙고 있습니다. 절대 사지 말고 꾹 참고 지켜만 보세요."
            action = "관망"
        elif macro_pos >= 20.0:
            ...
            color = "#10b981"
            desc = "거의 다 떨어졌습니다. 지금 당장 사지는 마시고, 슬슬 사볼 준비만 해보세요."
            action = "매수 대기"
        else:
    ...
    # ---------------------------------------------------------
        ...
        if macro_pos >= 90.0:
            ...
            color = "#dc2626"
            desc = "일정한 상자 안에 갇혀있는데 천장에 닿았습니다. 뚫기 어려우니 무조건 파세요."
            action = "천장 매도"
        elif macro_pos >= 80.0:
            ...
            color = "#fbd38d"
            desc = "위로 뚫고 나갈지 고민하는 자리입니다. 혹시 모르니 절반만 안전하게 파세요."
            action = "비중 축소"
        elif macro_pos >= 50.0:
            title = "😑 [장기 전략 20] 상자 위쪽 눈치 보기 (관망)"
            color = "#94a3b8"
            desc = "상자 한가운데서 살짝 위입니다. 굳이 무리해서 매매하지 말고 지켜보세요."
            action = "관망"
        elif macro_pos >= 35.0:
            ...
            color = "#10b981"
            desc = "상자 밑바닥에 딱 닿았습니다. 싸게 살 수 있는 아주 좋은 기회이니 매수하세요."
            action = "적극 매수"
        else:
