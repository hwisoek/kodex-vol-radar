        ...
        if N_total >= 30:
            ...
            if "portfolio_history" in st.session_state and len(st.session_state["portfolio_history"]) > 0:
                ...
                fig = make_subplots(
                    ...
                    subplot_titles=("📈 포트폴리오 MTM 자산 성장 곡선 (Equity Curve)", "📉 낙폭 (Drawdown %)")
                )
                
                # equity curve
                eq_vals = df_eq["equity"].values
                colors = ["#22c55e" if v >= 1.0 else "#ef4444" for v in eq_vals]
                ...
                # baseline at 1.0
                fig.add_hline(
                    y=1.0, line_dash="dot", line_color="rgba(148,163,184,0.6)",
                ...
                fig.update_layout(
                    ...
                    yaxis=dict(
                        ...
                        zeroline=False,
                        tickformat=".4f",
                        title=dict(text="자산 가치", font=dict(size=11)),
                    ),
                    yaxis2=dict(
                        showgrid=True,
                        gridcolor="rgba(148,163,184,0.1)",
